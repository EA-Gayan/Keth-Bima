  ...
  return (
    ...
    <View style={styles.container}>
      <Image
        ...
        style={styles.image}
      />
      <Text style={styles.title}>{selectedLang==0?translation[0].English:selectedLang==1?translation[0].Sinhala:null}</Text>
      <Text style={styles.subtitle}>{selectedLang==0?translation[1].English:selectedLang==1?translation[1].Sinhala:null}</Text>
      ...
      <TouchableOpacity
        ...
        <Text>{selectedLang==0?translation[2].English:selectedLang==1?translation[2].Sinhala:null}</Text>
      </TouchableOpacity>
    <LanguageModal 
